...
def _load_hetero_gnn() -> type:
    """Importa ``HeteroGnnFusion`` somente quando o GNN é instanciado."""
    from src.models.hetero_gnn import HeteroGnnFusion

    return HeteroGnnFusion
